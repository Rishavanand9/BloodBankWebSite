...
function submitForm(e){
  ...
  // Get values
  var additionalData = getInputVal('additionalData');
  var gender = getInputVal('gender');
  var bloodType = getInputVal('bloodType');
  var name = getInputVal('name');
  var phoneNo = getInputVal('phoneNo');
  var donorAddress= getInputVal('donorAddress');

  // Save message
  saveMessage(additionalData, gender , bloodType, name, phoneNo, donorAddress);
...
function saveMessage(additionalData, gender , bloodType, name, phoneNo, donorAddress){
